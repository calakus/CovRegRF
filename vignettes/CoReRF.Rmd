...
This R package implements the **Co**variance **Re**gression with **R**andom **F**orests (**CoReRF**) method described in Alakus et al. (2022) [<arxiv:...>](urllink). The theoretical details of the proposed method are presented in Section 1 followed by a data analysis using this method in Section 2. 
...
```{r, fig.show='hold', fig.width=5, fig.height=3, fig.align='center'}
